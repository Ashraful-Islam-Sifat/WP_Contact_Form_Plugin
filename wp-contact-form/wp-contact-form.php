 ...
 */
   ...
   function enqueue_plugin_styles() {
    ...
    $text_size = get_option( 'wpcf_text_size' );
 ...
 function wpcf_contents(){
   ...
   add_shortcode('wpcf_example_shortcode', 'wpcf_contents');//The shortcode of the plugin
...
function wpcf_admin_enqueue_style(){
  wp_enqueue_style('wpcf_admin_style', plugins_url( '/admin-style.css', __FILE__), false, "2.0.0");
}
...
function wpcf_plugin_settings_init() {
  ...
  register_setting('wpcf_plugin_options', 'wpcf_border_width');
  register_setting('wpcf_plugin_options', 'wpcf_text_size');
}
  ...
  <div class="wpcf_admin_wrapper">
    ...
    <div class="wpcf_admin_main_area">
      ...
      <div class="form-contents">
        ...
        <label for="wpcf_border_width" name="wpcf_border_width">Border Width</label>
        <input type="number" name="wpcf_border_width" value="<?php print get_option('wpcf_border_width') ?>">
        ...
        <label for="wpcf_text_size" name="wpcf_text_size">Text Size</label>
        <input type="number" name="wpcf_text_size" value="<?php print get_option('wpcf_text_size') ?>">
      ...
      <div class="wpcf_button">
        ...
        <input type="text" name="wpcf_btn_text" value="<?php print get_option('wpcf_btn_text') ?>">

        <label for="wpcf_btn_text_color" name="wpcf_btn_text_color">Text Color</label>
      ...
      <p class="admin-shortcode">Shortcode: [wpcf_example_shortcode]</p>
    </div>
